      ...
      <div className="popup">
        <div className="popup_inner">
          ...
          <div className="container">
            ...
            <div><h1>slot 1 array {this.state.s1}</h1></div>
            <div className="container">
              <button class="btn btn-outline-primary" onClick={this.spin}>Spin</button>
              <button class="btn btn-outline-primary" onClick={this.debug}>Debug</button>
              <button
